...
import kotlinx.android.synthetic.main.fragment_viewpagerindicator.*

class ViewPagerIndicatorFragmentCached : Fragment() {

    private lateinit var pagerAdapter: CountingAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View =
            inflater.inflate(R.layout.fragment_viewpagerindicator, container, false)


    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        pagerAdapter = CountingAdapter(LayoutInflater.from(context))
