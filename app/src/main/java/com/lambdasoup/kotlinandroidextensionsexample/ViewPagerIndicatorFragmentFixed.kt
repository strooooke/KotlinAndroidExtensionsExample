...
class ViewPagerIndicatorFragmentFixed : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View =
            inflater.inflate(R.layout.fragment_viewpagerindicator, container, false).apply {
                ...
                with(page_indicator) {
                    setViewPager(this@apply.viewpager)
                    page_indicator.setOnPageChangeListener(object : ViewPager.SimpleOnPageChangeListener() {
                        override fun onPageSelected(position: Int) {
                            this@apply.button_forward.setText(
